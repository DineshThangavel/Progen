...
public class RegisterSimulationTest {
	  Project testProject = null;
		...
		public void afterMethod(){
		  ...
		  public void testNewInputSimulatorWithAndGate() {
				try {
					System.out.println(logicInterface.processInput("new_register 1 rising"));
					...
					SignalBusObserver risingClkTriggerObserver = new SignalBusObserver(testProject.getProjectSimulator().getRisingEdgeTriggerSignal(),testProject.getProjectSimulator(),"rising-clk");
					
					System.out.println(testProject.getEntityManager().getEntityById("1").getOutputByName("output").getValue());
					
					System.out.println(logicInterface.processInput("connect_to_clock 1 clock"));
					
					System.out.println(logicInterface.processInput("add_input_stimulus 2 150 'change_sim_input simulator1 1' 301 'change_sim_input simulator2 1'"));
					
					System.out.println(logicInterface.processInput("add_input_stimulus 1 600 'change_sim_input simulator1 0'"));
					
					System.out.println(logicInterface.processInput("add_input_stimulus 1 730 'change_sim_input simulator1 1'"));
					
					System.out.println(logicInterface.processInput("simulate 0 1"));
					
					System.out.println("Rising_clk signal values:");
					risingClkTriggerObserver.printSignalLogToConsole();
					
					System.out.println("Register output values:");
