...
public class AndGateTest {
  ...
  public Object[][] dp() {
    return new Object[][] {
      new Object[] { new SignalBus("input1","1100"),new SignalBus("input2","0001"),new SignalBus("expected","0000")},
      new Object[] { new SignalBus("input1","1111"),new SignalBus("input2","0001"),new SignalBus("expected","0001")},
      new Object[] { new SignalBus("input1","1111"),new SignalBus("input2","1111"),new SignalBus("expected","1111")},
      new Object[] { new SignalBus("input1","0000"),new SignalBus("input2","0011"),new SignalBus("expected","0000")},
    };
  }
  ...
  public void defaultBehaviourTest(SignalBus input1,SignalBus input2, SignalBus expected) {
	  ...
	  SignalBus andGateOutput = andGateForTest.defaultBehaviour(inputList);
	
	  Assert.assertEquals(andGateOutput.getBusWidth(), expected.getBusWidth());
